...
<a href="{{action('AdminController@addProduct')}}" id="green_btn" class="btn btn-primary"
    style="border: 1px solid black; width: 200px; margin-left: 30px">
            ...
            <table class="table table-hover table-condensed">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @endif
                        @endforeach
                        <td width="50"><a href="{{route('adminRoutes.productedit', $asPro->id_preke)}}"><button
                                    class="button" type="edit"><svg class="bi bi-pencil" width="1em" height="1em"
                        ...
                        <td width="50"><a onclick="return confirm('Ar tikrai norite ištrinti apartamentą?')"
                                href="{{route('adminRoutes.deleteProduct', $asPro->id_preke)}}"><button class="button"
                                    type="delete"><svg class="bi bi-x-square-fill" width="1em" height="1em"
                                        viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
