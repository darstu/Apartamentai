        ...
        <div class="col-lg-8 offset-lg-1" style="padding-top: 10px; margin-left: -15px;width: 900px">
            ...
            @foreach($allPro as $asPro)
                <tr>
                    ...
                    <td width="50"><a onclick="return confirm('Ar tikrai norite ištrinti apartamentą?')" href="{{route('adminRoutes.deleteProduct', $asPro->id_preke)}}"><button class="button" type="delete"><svg class="bi bi-x-square-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
